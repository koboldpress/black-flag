...
import { formatNumber, formatNumberParts } from "./number.mjs";
...
export function registerHandlebarsHelpers() {
	Handlebars.registerHelper({
		...
		"blackFlag-number": (number, options) => formatNumber(number, options.hash),
		"blackFlag-numberParts": (number, options) =>
			new Handlebars.SafeString(formatNumberParts(number, options.hash)),
		"blackFlag-signedNumber": (number, options) =>
			new Handlebars.SafeString(formatNumberParts(number, { sign: true, ...options.hash }))
	});
}
...
export async function registerHandlebarsPartials() {
	const partials = [
		...
		"item/description/description-currency.hbs",
		"item/description/description-equipment.hbs",
		"item/description/description-feature.hbs",
		"item/description/description-spell.hbs",
		"item/description/description-talent.hbs",
		"item/details/details-ammunition.hbs",
		"item/details/details-armor.hbs",
		"item/details/details-consumable.hbs",
		"item/details/details-container.hbs",
		"item/details/details-feature.hbs",
		"item/details/details-gear.hbs",
		"item/details/details-spell.hbs",
		"item/details/details-talent.hbs",
		"item/details/details-tool.hbs",
		"item/details/details-weapon.hbs",
